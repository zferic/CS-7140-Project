...
class BaseArgs:
  ...
  def __init__(self):
    ...
    self.parser.add_argument('--n_frames_input', type=int, default=8)
    self.parser.add_argument('--n_frames_output', type=int, default=1)
    ...
    # ckpt and logging
    self.parser.add_argument('--ckpt_dir', type=str, default=os.path.join(os.environ['HOME'], 'FactorDynamics/DDPAE-MD/tensorboard', 'ckpt'),
